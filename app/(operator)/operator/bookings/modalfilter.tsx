...
export type Status = 'Pending' | 'Confirmed' | 'In Progress' | 'Completed' | 'Cancelled';
...
export default function FilterModal({
  ...
  return (
    <div className="fixed inset-0 z-[70] flex lg:left-[4.5rem]" role="dialog" aria-modal="true" aria-label="Booking filters">
      <style jsx>{`
      ...
      <aside className="anim-slide relative ml-0 flex h-full w-full max-w-sm flex-col overflow-hidden border-r border-white/40 bg-white/70 shadow-2xl ring-1 ring-black/5 backdrop-blur-xl backdrop-saturate-150">
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5">
          ...
          <div className="mt-4">
            ...
            {(['Pending', 'Confirmed', 'In Progress', 'Completed', 'Cancelled'] as Status[]).map((s) => (
