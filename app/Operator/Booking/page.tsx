...
import BookingDetailsCard, { Booking } from '@/components/operator/booking/details';
import CalendarAvailability from '@/components/operator/booking/calendar';
import FilterModal, {
  createEmptyFilters,
  type BookingFilters,
  type Status,
} from '@/components/operator/booking/modalfilter';
