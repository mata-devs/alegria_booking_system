        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            <p className="font-semibold">
              {enabled ? 'Guest homepage hero is on.' : 'Guest homepage hero is off.'}
            </p>
            <p className="mt-0.5 text-xs">
              {enabled
                ? 'The landing page uses this hero + ticker when published.'
                : 'The landing page uses the default static hero. Turn on in Settings to publish CMS hero + ticker.'}
            </p>
          </div>
        </div>
        <Link
