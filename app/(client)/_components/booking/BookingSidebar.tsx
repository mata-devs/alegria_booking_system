...
import type { CalendarSlotStatus } from "@/app/(client)/booking/_components/types";

// ─── Constants ────────────────────────────────────────────────────────────────
const SERVICE_CHARGE = 500;
const MATA_SERVICE_FEE = 500;
const LGU_SERVICE_FEE = 500;
const PRESET_GUESTS = [1, 2, 3, 4, 5] as const;
    ...
    return (
        <>
            <div className="w-full lg:w-[380px] xl:w-[400px] shrink-0">
                <div className="bg-white rounded-3xl p-8 shadow-2xl shadow-black/5 border border-gray-100 sticky top-28">
