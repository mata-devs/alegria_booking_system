...
// Strip everything except digits, then validate exactly 10 digits (local PH format).
...
export const representativeFormSchema = z.object({
  ...
  // Stored value is the full E.164 string e.g. "+639171234567".
  // We strip the +63 prefix then validate the remaining 10 digits.
  repPhone: z
    .string()
    .trim()
