...
export default function BookingHistoryPanel({
  ...
  return (
    <div className="w-full min-w-0 flex flex-col gap-5">
      ...
      <div className=" rounded-2xl border border-neutral-200 bg-white p-4 h-auto max-h-188 hide-scrollbar overflow-y-scroll">
        {/* Filters + Search */}
  ...
  {bookings.map((b) => {
    ...
    return (
        <div
          ...
          className={[
            "rounded-xl bg-neutral-100 px-4 py-3 cursor-pointer",
